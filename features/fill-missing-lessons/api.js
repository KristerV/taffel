...
export async function fetchJournalStudents(journalId) {
...
export async function fetchTimetable(teacherId) {
...
export async function postJournalEntry(journalId, payload, token) {
...
export function createEntryPayload(date, startLessonNr, lessonCount, students, teacherId) {
